...
?>
	...
	<section id="sidebar">
		...
		<ul class="side-menu">
            ...
            <li><a href="#"><i class='bx bxs-chart icon' ></i> Campers</a></li>
			<li>
				...
				<ul class="side-dropdown">
					...
					<li><a class="enlace" data-urldestino="view/Regions/mainregion.php" href="#">Departamentos</a></li>
					<li><a class="enlace" data-urldestino="view/Cities/maincity.php" href="#">Regiones</a></li>
				</ul>
			</li>
